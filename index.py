...
# -*- coding: utf-8 -*-
# ----------------------------------------------------------------------------
# Created By  : Guilherme Costa Alves
# Created Date: Dez - 2022
# version ='1.0'
# ---------------------------------------------------------------------------
import time
from clientes import Cliente as cadcli
from clientes import Cores as cor
...
if __name__ == "__main__":
        ...
        while len(lista_cli) != tamanho_lista + qtd:
            while True:
                ...
                while True:
                    ...
                    confirma_cpf = input(
                        f"Confirma este CPF: {cpf} (S/N): ").upper()
                    if confirma_cpf[0] == "S":
                        print("CONFIRMADO")
                        break
                    else:
                ...
                while True:
                    ...
                    confirma_telefone = input(
                        f"Confirma este Telefone: {telefone} (S/N): ").upper()
                ...
                while True:
                    ...
                    try:
                        ...
                        print(
                            f"{cor.vermelho}IDADE PRECISA SER INTEIRO{cor.normal}")
                        continue
                endereco = input(
                    "Digite nome da rua e numero da casa: ").title()
    ...
    def consultar_cpf():
        ...
        while True:
            ...
            confirmar = input(
                "Confirma a procura pelo CPF acima ? (S/N): ").upper()
            if confirmar[0] == "S":
                break
            else:
                continue
    ...
    def alterar_cpf():
        ...
        for i in lista_cli:
            if i.cpf == cpf_busca:
                ...
                time.sleep(3)
                print(
                    f"{cor.vermelho}INSIRA O CPF SEM ESPAÇOS, PONTOS OU TRAÇOS{cor.normal}")
    ...
    def alterar_telefone():
        print(
            f"{cor.vermelho}INSIRA O NUMERO DE CELULAR SEM ESPAÇOS, PONTOS OU TRAÇOS{cor.normal}")
        while True:
        ...
        for i in lista_cli:
            if i.telefone == tel_busca:
                ...
                time.sleep(3)
                print(
                    f"{cor.vermelho}INSIRA O TELEFONE SEM ESPAÇOS, PONTOS OU TRAÇOS{cor.normal}")
